...
# Usage: rails new APP_NAME -m https://github.com/12spokes/rails3-application-templates/raw/master/rails3-bike-pump.rb -T
...
@recipes = ["slim", "rspec", "cucumber", "guard", "action_mailer", "devise", 
            "add_user", "home_page", "home_page_users", "seed_database", "users_page", 
            "html5", "simple_form", "cleanup", "extras", "git"]
...
if config['slim']
  gem 'slim', '>= 3.1.6'
  gem 'slim-rails', '>= 0.3.4', :group => :development
else
  recipes.delete('slim')
end
...
RUBY
  ...
  after_everything do
    ...
    if recipes.include? 'rspec'
      ...
      remove_file 'spec/views/home/index.html.slim_spec.rb'
      remove_file 'spec/views/users/show.html.erb_spec.rb'
      remove_file 'spec/views/users/show.html.slim_spec.rb'
...
RUBY
    ...
    unless recipes.include? 'slim'
      # Generate Devise views (unless you are using slim)
...
ERB
      ...
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/devise-views-slim/app/views/devise/shared/_links.html.slim', 'app/views/devise/shared/_links.html.slim'
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/devise-views-slim/app/views/devise/registrations/edit.html.slim', 'app/views/devise/registrations/edit.html.slim'
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/devise-views-slim/app/views/devise/registrations/new.html.slim', 'app/views/devise/registrations/new.html.slim'
    end
...
after_bundler do
  ...
  unless recipes.include? 'bootstrap'
    if recipes.include? 'slim'
      # slim version of a simple application layout
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/simple/views/layouts/application.html.slim', 'app/views/layouts/application.html.slim'
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/simple/views/layouts/_messages.html.slim', 'app/views/layouts/_messages.html.slim'
    else
    ...
    if recipes.include? 'slim'
      # slim version of a complex application layout using Twitter Bootstrap
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/twitter-bootstrap/views/layouts/application.html.slim', 'app/views/layouts/application.html.slim'
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/twitter-bootstrap/views/layouts/_messages.html.slim', 'app/views/layouts/_messages.html.slim'
    else
  ...
  if recipes.include? 'slim'
    if recipes.include? 'devise'
      if recipes.include? 'authorization'
        get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/navigation/devise/authorization/_navigation.html.slim', 'app/views/layouts/_navigation.html.slim'
      else
        get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/navigation/devise/_navigation.html.slim', 'app/views/layouts/_navigation.html.slim'        
      end
    elsif recipes.include? 'omniauth'
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/navigation/omniauth/_navigation.html.slim', 'app/views/layouts/_navigation.html.slim'
    elsif recipes.include? 'subdomains'
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/navigation/subdomains/_navigation.html.slim', 'app/views/layouts/_navigation.html.slim'
    else
      get 'https://raw.github.com/RailsApps/rails3-application-templates/master/files/navigation/none/_navigation.html.slim', 'app/views/layouts/_navigation.html.slim'
    end
  else
    if recipes.include? 'devise'
      if recipes.include? 'authorization'
  ...
  if recipes.include? 'slim'
    ...
    gsub_file 'app/views/layouts/_navigation.html.slim', /App_Name/, "#{app_name.humanize.titleize}"
  else
